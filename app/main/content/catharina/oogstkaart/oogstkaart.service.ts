...
oogstkaartid : number   */
  ...
  /**
   * UpdateOogstkaartItem
   */
  public UpdateOogstkaartItem(id: number, item: OogstKaartItem) {
    return this.http.post(Utils.getRoot() + "/api/Oogstkaart/update/"+id, item, { headers: this.auth.getAuthorizationHeaders() } ) 
  }
