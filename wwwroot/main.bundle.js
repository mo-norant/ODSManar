...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.createUser = function (user) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_3__models_Util__["a" /* Utils */].getRoot() + "Identity/Create", user);
    };
    AuthService.prototype.createCompany = function (company, id) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_3__models_Util__["a" /* Utils */].getRoot() + "Identity/Companyinfo?id=" + id, company);
    };
...
var OogstkaartformComponent = /** @class */ (function () {
    ...
    OogstkaartformComponent.prototype.upload = function (files) {
        ...
        var uploadReq = new __WEBPACK_IMPORTED_MODULE_6__angular_common_http__["g" /* HttpRequest */]('POST', __WEBPACK_IMPORTED_MODULE_7__models_Util__["a" /* Utils */].getRoot() + "/api/Oogstkaart/oogstkaartavatar/" + this.oogstkaartID, formData, {
            reportProgress: true,
