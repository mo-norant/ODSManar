...
var OogstkaartformComponent = /** @class */ (function () {
    ...
    OogstkaartformComponent.prototype.upload = function (files) {
        ...
        var uploadReq = new __WEBPACK_IMPORTED_MODULE_6__angular_common_http__["g" /* HttpRequest */]('POST', __WEBPACK_IMPORTED_MODULE_7__models_Util__["a" /* Utils */].getRoot() + "Oogstkaart/oogstkaartavatar/" + this.oogstkaartID, formData, {
            reportProgress: true,
...
/* unused harmony export Specificatie */
